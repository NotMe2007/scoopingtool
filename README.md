...
- **100+ Stars** - ***GUI Changes + Code overhaul and every 10 stars an update!*** ✅
- **500+ Stars** - ***Kernel Integration*** ❌

↳ (Currently, @toto, @Starcharms, and I are working on the Kernel Integration. However, this process takes time. We are not merely adding a DMIEDIT edit executed by the spoofer; instead, we are developing a complete driver that communicates with Spoofy, supporting both Win10 and Win11.)
